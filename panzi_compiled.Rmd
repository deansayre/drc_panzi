...
data5_1 <- powerjoin::power_left_join(linelist_normalized, lab_normalized, 
...
lab2 <- lab1 %>% 
  summarise(flu_prev = sum(influenza == "type_a", na.rm = TRUE)/(sum(influenza == "negatif", na.rm = TRUE)+
                                                                   sum(influenza == "type_a", na.rm = TRUE)),
            covid_prev = sum(sars_cov2 == "positif", na.rm = TRUE)/(sum(sars_cov2 == "negatif", na.rm = TRUE)+
                                                                   sum(sars_cov2 == "positif", na.rm = TRUE)), 
            mal_prev = sum(tdr_palu == "positif", na.rm = TRUE)/(sum(tdr_palu == "negatif", na.rm = TRUE)+
                                                                   sum(tdr_palu == "positif", na.rm = TRUE))
            )

lab3 <- lab1 %>% 
  mutate(coinfx = case_when(tdr_palu == "positif" & influenza == "type_a" ~ "mal_flu", 
                            tdr_palu == "positif" & sars_cov2 == "positif" ~ "mal_covid",
                            influenza == "type_a" & sars_cov2 == "positif" ~ "flu_covid", 
