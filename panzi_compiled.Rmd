...
cfr_graph <- tpr_cfr_by_presentation_graph %>% 
  ggplot()+
  geom_col(aes(x = list_sx_1, 
               y = cfr), 
           color = "black",
...
cowplot::plot_grid(top, heat,  NULL,
                   cfr_graph, 
                   ncol = 1, 
                   rel_heights = c(1,1, -0.4, 1),
                   align = "hv", 
                   axis = "tblr")
